(exp_wama_processor_authoring)=

```{meta}
:description: Deferred design for a constrained authoring experience for standard WAMA measurement processors.
```
...
- [Overview and processes](wama-platform-overview.md)
- [Architecture and technology choices](wama-architecture.md)
- [Data flow and Kafka contracts](../reference/wama-data-flow-contracts.md)
- [PoC Compose plan](wama-poc-compose-plan.md)
