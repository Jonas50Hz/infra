...
manage its adapters, or start and control the simulator.
...
PMU IDCODEs `1001` through `1005`. The C37.118 gateway repository neither
deploys, restarts, nor stops the simulator.

The gateway workflow's bounded live verification requires this matching
