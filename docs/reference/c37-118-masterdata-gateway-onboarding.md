...
five-PMU V2 source fixture. A fresh onboarding seed uses its initial `main`
...
PMU IDCODEs `1001` through `1005`. The onboarding repository neither deploys,
...
the verifier from the marker-owned onboarding deployment root after adapter
