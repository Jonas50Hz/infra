...
from gateway_c37_118.config import CatalogError, load_catalog
...
class CatalogTests(unittest.TestCase):
    ...
    def test_loads_every_shipped_catalog_source(self) -> None:
        ...
        catalog = load_catalog(catalog_directory, "wama-c37-118", "abc123")
    ...
    def test_loads_sorted_valid_sources(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            catalog = load_catalog(root, "wama-c37-118", "abc123")
    ...
    def test_allows_empty_catalog_for_complete_decommissioning(self) -> None:
        with TemporaryDirectory() as directory:
            catalog = load_catalog(directory, "wama-c37-118", "abc123")
    ...
    def test_rejects_duplicate_mrids_across_sources(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            with self.assertRaisesRegex(CatalogError, "Duplicate MRID"):
                load_catalog(root, "wama-c37-118", "abc123")
