...
from gateway_c37_118.publisher import (
    Settings,
    publish_plan,
    read_compacted_state,
)
from gateway_c37_118.reconciliation import PublishRecord, ReconciliationPlan
...
class PublisherTests(unittest.TestCase):
    ...
    def test_uses_expected_local_defaults(self) -> None:
        ...
        self.assertEqual(settings.catalog_id, "wama-c37-118")
