"""Synchronize and deploy exactly one Forgejo-owned processor service."""
...
EXPECTED_SERVICE = "processor-frequency-scale"
...
def deploy_processor(
    ...
    """Pull and recreate the expected processor on the external infrastructure network."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--project-name",
        default=os.environ.get("WAMA_PROCESSOR_COMPOSE_PROJECT_NAME", "wama-processor-frequency-scale"),
    )
