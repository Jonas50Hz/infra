...
class ExportTests(unittest.TestCase):
    """Require direct valid frequency values to yield one configured M_ME_NC_1."""

    def test_builds_deterministic_timestamp_and_quality_aligned_export(self) -> None:
        source = _frequency(50.01)
        ...
        self.assertEqual(record.iec104_asdu.common_address, 1)
...
def _frequency(value: float) -> rtd_schema_pb2.MCCSMeasurementValue:
