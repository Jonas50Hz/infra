"""Tests for the standalone direct frequency IEC 104 deployment guard."""
...
class DeploymentGuardTests(unittest.TestCase):
    """Keep one direct export processor deployment isolated from other services."""
    ...
    def test_rejects_other_or_missing_compose_services(self) -> None:
        with self.assertRaisesRegex(DeploymentError, "processor-frequency-iec104-export"):
    ...
    def test_rejects_a_marked_root_outside_the_expected_base_child(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            expected = base / "processor-frequency-iec104-export"
            unexpected = root / "other" / "processor-frequency-iec104-export"
