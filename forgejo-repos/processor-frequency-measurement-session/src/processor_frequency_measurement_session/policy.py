...
CAPTURE_POLICIES = (
    FrequencyCapturePolicy(
        ...
        capture_mrids=(
            "urn:wama:poc:pmu:bay-01:current-phase-a",
            "urn:wama:poc:pmu:bay-01:current-phase-b",
            "urn:wama:poc:pmu:bay-01:current-phase-c",
            "urn:wama:poc:pmu:bay-01:frequency",
            "urn:wama:poc:pmu:bay-01:rocof",
            "urn:wama:poc:pmu:bay-01:voltage-phase-a",
            "urn:wama:poc:pmu:bay-01:voltage-phase-b",
            "urn:wama:poc:pmu:bay-01:voltage-phase-c",
        ),
    ),
    FrequencyCapturePolicy(
        frequency_mrid="urn:wama:poc:pmu:bay-02:frequency",
        capture_mrids=(
            "urn:wama:poc:pmu:bay-02:current-phase-a",
            "urn:wama:poc:pmu:bay-02:current-phase-b",
            "urn:wama:poc:pmu:bay-02:current-phase-c",
            "urn:wama:poc:pmu:bay-02:frequency",
            "urn:wama:poc:pmu:bay-02:rocof",
            "urn:wama:poc:pmu:bay-02:voltage-phase-a",
            "urn:wama:poc:pmu:bay-02:voltage-phase-b",
            "urn:wama:poc:pmu:bay-02:voltage-phase-c",
        ),
    ),
    FrequencyCapturePolicy(
        frequency_mrid="urn:wama:poc:pmu:bay-03:frequency",
        capture_mrids=(
            "urn:wama:poc:pmu:bay-03:current-phase-a",
            "urn:wama:poc:pmu:bay-03:current-phase-b",
            "urn:wama:poc:pmu:bay-03:current-phase-c",
            "urn:wama:poc:pmu:bay-03:frequency",
            "urn:wama:poc:pmu:bay-03:rocof",
            "urn:wama:poc:pmu:bay-03:voltage-phase-a",
            "urn:wama:poc:pmu:bay-03:voltage-phase-b",
            "urn:wama:poc:pmu:bay-03:voltage-phase-c",
        ),
    ),
)
