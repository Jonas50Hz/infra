...
from processor_apparent_power.config import ConfigurationError, load_config
...
consumer_group: processor-apparent-power
...
"""
        ...
        self.assertEqual(config.consumer_group, "processor-apparent-power")
