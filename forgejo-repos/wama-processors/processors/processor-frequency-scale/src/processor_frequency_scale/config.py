"""Configuration loading for a processors-repository Quixstreams processor."""
...
class ConfigurationError(ValueError):
    """Raised when a processor configuration is invalid."""


@dataclass(frozen=True)
class ProcessorConfig:
    """Kafka settings owned by one processor."""
