...
rollup. Its hourly segment row ceiling is sized for the three-PMU V2 fixture's
approximately 1,200 records per second; byte-based intermediate persists retain
